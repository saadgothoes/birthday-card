...
<head>
    ...
    <title>Anniversary Card - Page 1</title>
    <style>
    * {
        margin: 0;
        padding: 0;
    ...
    body {
        background: linear-gradient(135deg, #a35a56 0%, #8f4a47 30%, #7a3d3c 60%, #5c1420 100%);
        display: flex;
        align-items: center;
    ...
    .boy2-wrap {
        ...
        overflow: hidden;
        position: relative;
        box-shadow: 0 20px 60px rgba(30, 8, 8, 0.5);
    }
    ...
    .gold-particle {
        position: absolute;
        border-radius: 50%;
        background: radial-gradient(circle, #c9a75c, #a3792f);
        opacity: 0;
    ...
    .arch-border {
        position: absolute;
        inset: 0;
        border: 2.5px solid #a3792f;
        border-radius: 110px 110px 8px 8px;
        box-shadow: 0 0 0 6px rgba(163, 121, 47, 0.15), 0 0 0 12px rgba(163, 121, 47, 0.07), inset 0 0 30px rgba(163, 121, 47, 0.1);
    }
    ...
    .arch-photo {
        ...
        overflow: hidden;
        background: linear-gradient(180deg, #7a1620 0%, #4a0f18 100%);
        position: relative;
    }
    ...
    .crown-top {
        ...
        font-size: 28px;
        filter: drop-shadow(0 0 8px rgba(201, 167, 92, 0.6));
    }
    ...
    .boy2-right {
        width: 35%;
        min-width: 280px;
        background: rgba(92, 20, 32, 0.2);
        border-left: 1px solid rgba(201, 167, 92, 0.25);
        display: flex;
    ...
    .boy2-code-box {
        ...
        border: 1.5px solid rgba(201, 167, 92, 0.4);
        border-radius: 8px;
        background: rgba(92, 20, 32, 0.25);
        display: flex;
        align-items: center;
        justify-content: center;
        font-family: 'Playfair Display', serif;
    ...
    .boy2-code-box.active {
        border-color: #a3792f;
        box-shadow: 0 0 16px rgba(163, 121, 47, 0.3), inset 0 0 8px rgba(163, 121, 47, 0.08);
    }
    ...
    .boy2-code-box::after {
        ...
        width: 24px;
        height: 1.5px;
        background: rgba(201, 167, 92, 0.45);
        border-radius: 1px;
    }

    .boy2-code-box.active::after {
        background: #f0d9a5;
        box-shadow: 0 0 6px rgba(240, 217, 165, 0.55);
    ...
    .boy2-btn:hover {
        background: rgba(163, 121, 47, 0.22);
        border-color: #a3792f;
        box-shadow: 0 0 16px rgba(163, 121, 47, 0.25);
        transform: translateY(-1px);
    }

    .boy2-btn.sym {
        color: rgba(240, 217, 165, 0.5);
    ...
    .divider-gold {
        width: 80px;
        height: 1px;
        background: linear-gradient(90deg, transparent, rgba(201, 167, 92, 0.55), transparent);
        margin: -4px 0;
    }
...
<body>
    <div class="boy2-wrap">
        ...
        <div class="boy2-deco">
            ...
            <div
                style="position:absolute;top:0;left:0;right:0;bottom:0;background:radial-gradient(ellipse at 30% 50%, rgba(163,121,47,0.1) 0%, transparent 60%);pointer-events:none">
            </div>
                    ...
                    <svg viewBox="0 0 190 256" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <linearGradient id="bsky" x1="0" y1="0" x2="0" y2="1">
                                ...
                                <stop offset="50%" stop-color="#6e1420" />
                                <stop offset="100%" stop-color="#4a0f18" />
                            </linearGradient>
                            <linearGradient id="sunset" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="0%" stop-color="#a3792f" stop-opacity="0.5" />
                        ...
                        <ellipse cx="95" cy="300" rx="130" ry="70" fill="#3a0d14" clip-path="url(#archclip)" />
                        <rect x="68" y="148" width="54" height="80" rx="5" fill="#5c1420" clip-path="url(#archclip)" />
                        <ellipse cx="95" cy="138" rx="26" ry="28" fill="#7a3d3c" clip-path="url(#archclip)" />
                        <path d="M68 148 Q95 125 122 148" stroke="#a3792f" stroke-width="1.5" fill="none"
                            clip-path="url(#archclip)" />
                        <rect x="62" y="200" width="22" height="45" rx="3" fill="#5c1420" clip-path="url(#archclip)" />
                        <rect x="106" y="200" width="22" height="45" rx="3" fill="#5c1420" clip-path="url(#archclip)" />
                        <ellipse cx="95" cy="50" rx="50" ry="20" fill="rgba(201,167,92,0.12)"
                            clip-path="url(#archclip)" />
                        <circle cx="40" cy="30" r="4" fill="rgba(201,167,92,0.22)" clip-path="url(#archclip)" />
                        <circle cx="155" cy="45" r="3" fill="rgba(201,167,92,0.18)" clip-path="url(#archclip)" />
                        <circle cx="20" cy="80" r="2" fill="rgba(201,167,92,0.25)" clip-path="url(#archclip)" />
                        <circle cx="170" cy="90" r="2.5" fill="rgba(201,167,92,0.18)" clip-path="url(#archclip)" />
                    </svg>
                    @endif
                </div>
