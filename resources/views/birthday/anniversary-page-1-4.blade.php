...
<head>
    ...
    * {
    ...
    body {
        background: linear-gradient(135deg, #e3bcab 0%, #dba896 30%, #cf9880 60%, #c4917c 100%);
        display: flex;
        align-items: center;
    ...
    .boy2-wrap {
        ...
        overflow: hidden;
        position: relative;
        box-shadow: 0 20px 60px rgba(92, 23, 18, 0.4);
    }
    ...
    .gold-particle {
        position: absolute;
        border-radius: 50%;
        background: radial-gradient(circle, #f5efe8, #e8281a);
        opacity: 0;
    ...
    .arch-border {
        position: absolute;
        inset: 0;
        border: 2.5px solid #e8281a;
        border-radius: 110px 110px 8px 8px;
        box-shadow: 0 0 0 6px rgba(232, 40, 26, 0.13), 0 0 0 12px rgba(232, 40, 26, 0.06), inset 0 0 30px rgba(232, 40, 26, 0.08);
    }
    ...
    .arch-photo {
        ...
        overflow: hidden;
        background: linear-gradient(180deg, #e8281a 0%, #a01813 100%);
        position: relative;
    }
    ...
    .crown-top {
        ...
        font-size: 28px;
        filter: drop-shadow(0 0 8px rgba(245, 239, 232, 0.7));
    }
    ...
    .boy2-right {
        ...
        border-left: 1px solid rgba(92, 23, 18, 0.2);
        display: flex;
    ...
    .boy2-code-box {
        ...
        border: 1.5px solid rgba(232, 40, 26, 0.4);
        border-radius: 8px;
    ...
    .boy2-code-box.active {
        border-color: #e8281a;
        box-shadow: 0 0 16px rgba(232, 40, 26, 0.28), inset 0 0 8px rgba(232, 40, 26, 0.08);
    }
    ...
    .boy2-code-box::after {
        ...
        width: 24px;
        height: 1.5px;
        background: rgba(232, 40, 26, 0.45);
        border-radius: 1px;
    }

    .boy2-code-box.active::after {
        background: #e8281a;
        box-shadow: 0 0 6px rgba(232, 40, 26, 0.5);
    ...
    .boy2-btn:hover {
        ...
        border-color: #e8281a;
        box-shadow: 0 0 16px rgba(232, 40, 26, 0.22);
        transform: translateY(-1px);
    }

    .boy2-btn.sym {
        color: rgba(92, 23, 18, 0.5);
    ...
    .divider-gold {
        width: 80px;
        height: 1px;
        background: linear-gradient(90deg, transparent, rgba(232, 40, 26, 0.5), transparent);
        margin: -4px 0;
    }
...
<body>
    <div class="boy2-wrap">
        ...
        <div class="boy2-deco">
            ...
            <div
                style="position:absolute;top:0;left:0;right:0;bottom:0;background:radial-gradient(ellipse at 30% 50%, rgba(232,40,26,0.08) 0%, transparent 60%);pointer-events:none">
            </div>
                    ...
                    <svg viewBox="0 0 190 256" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <linearGradient id="bsky" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="0%" stop-color="#e8281a" />
                                <stop offset="50%" stop-color="#c11f1a" />
                                <stop offset="100%" stop-color="#a01813" />
                            </linearGradient>
                            <linearGradient id="sunset" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="0%" stop-color="#f5efe8" stop-opacity="0.4" />
                        ...
                        <ellipse cx="95" cy="300" rx="130" ry="70" fill="#7a1310" clip-path="url(#archclip)" />
                        <rect x="68" y="148" width="54" height="80" rx="5" fill="#5c1712" clip-path="url(#archclip)" />
                        <ellipse cx="95" cy="138" rx="26" ry="28" fill="#c4917c" clip-path="url(#archclip)" />
                        <path d="M68 148 Q95 125 122 148" stroke="#f5efe8" stroke-width="1.5" fill="none"
                            clip-path="url(#archclip)" />
                        <rect x="62" y="200" width="22" height="45" rx="3" fill="#5c1712" clip-path="url(#archclip)" />
                        <rect x="106" y="200" width="22" height="45" rx="3" fill="#5c1712" clip-path="url(#archclip)" />
                        <ellipse cx="95" cy="50" rx="50" ry="20" fill="rgba(245,239,232,0.15)"
                            clip-path="url(#archclip)" />
                        <circle cx="40" cy="30" r="4" fill="rgba(245,239,232,0.25)" clip-path="url(#archclip)" />
                        <circle cx="155" cy="45" r="3" fill="rgba(245,239,232,0.2)" clip-path="url(#archclip)" />
                        <circle cx="20" cy="80" r="2" fill="rgba(245,239,232,0.28)" clip-path="url(#archclip)" />
                        <circle cx="170" cy="90" r="2.5" fill="rgba(245,239,232,0.2)" clip-path="url(#archclip)" />
                    </svg>
                    @endif
                </div>
