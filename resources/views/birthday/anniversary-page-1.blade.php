...
<head>
    ...
    * {
    ...
    body {
        background: linear-gradient(135deg, #c7bca6 0%, #b3a68c 30%, #a3957a 60%, #8f7f65 100%);
        display: flex;
        align-items: center;
    ...
    .boy2-wrap {
        ...
        overflow: hidden;
        position: relative;
        box-shadow: 0 20px 60px rgba(20, 18, 15, 0.45);
    }
    ...
    .gold-particle {
        position: absolute;
        border-radius: 50%;
        background: radial-gradient(circle, #2b2925, #141312);
        opacity: 0;
    ...
    .arch-border {
        ...
        box-shadow: 0 0 0 6px rgba(20, 19, 18, 0.1), 0 0 0 12px rgba(20, 19, 18, 0.05), inset 0 0 30px rgba(20, 19, 18, 0.08);
    }
    ...
    .arch-border::before {
        ...
        position: absolute;
        inset: 5px;
        border: 1px solid rgba(20, 19, 18, 0.3);
    ...
    .arch-photo {
        ...
        overflow: hidden;
        background: linear-gradient(180deg, #f2ece0 0%, #d5cdb7 100%);
        position: relative;
    }
    ...
    .crown-top {
        ...
        font-size: 28px;
        filter: drop-shadow(0 0 8px rgba(20, 19, 18, 0.5));
    }
    ...
    .boy2-right {
        ...
        border-left: 1px solid rgba(20, 19, 18, 0.2);
        display: flex;
    ...
    .boy2-code-box {
        ...
        border: 1.5px solid rgba(20, 19, 18, 0.35);
        border-radius: 8px;
    ...
    .boy2-code-box.active {
        border-color: #141312;
        box-shadow: 0 0 16px rgba(20, 19, 18, 0.25), inset 0 0 8px rgba(20, 19, 18, 0.08);
    }
    ...
    .boy2-code-box.active::after {
        background: #141312;
        box-shadow: 0 0 6px rgba(20, 19, 18, 0.5);
    ...
    .boy2-btn:hover {
        ...
        border-color: #141312;
        box-shadow: 0 0 16px rgba(20, 19, 18, 0.15);
    ...
    .divider-gold {
        width: 80px;
        height: 1px;
        background: linear-gradient(90deg, transparent, rgba(20, 19, 18, 0.5), transparent);
        margin: -4px 0;
    }
...
<body>
    <div class="boy2-wrap">
        ...
        <div class="boy2-deco">
            ...
            <div
                style="position:absolute;top:0;left:0;right:0;bottom:0;background:radial-gradient(ellipse at 30% 50%, rgba(20,19,18,0.06) 0%, transparent 60%);pointer-events:none">
            </div>
                    ...
                    <svg viewBox="0 0 190 256" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <linearGradient id="bsky" x1="0" y1="0" x2="0" y2="1">
                                ...
                                <stop offset="50%" stop-color="#e4ddcb" />
                                <stop offset="100%" stop-color="#d5cdb7" />
                            </linearGradient>
                            <linearGradient id="sunset" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="0%" stop-color="#8f7f65" stop-opacity="0.5" />
                        ...
                        <ellipse cx="95" cy="300" rx="130" ry="70" fill="#c7bca6" clip-path="url(#archclip)" />
                        <rect x="68" y="148" width="54" height="80" rx="5" fill="#141312" clip-path="url(#archclip)" />
                        <ellipse cx="95" cy="138" rx="26" ry="28" fill="#3a3733" clip-path="url(#archclip)" />
                        <path d="M68 148 Q95 125 122 148" stroke="#1c1a17" stroke-width="1.5" fill="none"
                            clip-path="url(#archclip)" />
                        <rect x="62" y="200" width="22" height="45" rx="3" fill="#141312" clip-path="url(#archclip)" />
                        <rect x="106" y="200" width="22" height="45" rx="3" fill="#141312" clip-path="url(#archclip)" />
                        <ellipse cx="95" cy="50" rx="50" ry="20" fill="rgba(20,19,18,0.08)"
                            clip-path="url(#archclip)" />
                        <circle cx="40" cy="30" r="4" fill="rgba(20,19,18,0.15)" clip-path="url(#archclip)" />
                        <circle cx="155" cy="45" r="3" fill="rgba(20,19,18,0.12)" clip-path="url(#archclip)" />
                        <circle cx="20" cy="80" r="2" fill="rgba(20,19,18,0.18)" clip-path="url(#archclip)" />
                        <circle cx="170" cy="90" r="2.5" fill="rgba(20,19,18,0.12)" clip-path="url(#archclip)" />
                    </svg>
                    @endif
                </div>
