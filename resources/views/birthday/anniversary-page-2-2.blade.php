...
<head>
    ...
    <title>Anniversary Card - Engraved Letter - Red &amp; Gold</title>
    <style>
        ...
        * {
        ...
        :root {
            ...
            --cream: #8b1e28;
            --ink: #f2ece0;
            --ink-soft: rgba(242, 236, 224, 0.78);
            --gold: #a3792f;
            --gold-light: #cf9f52;
        }
        ...
        .om-card {
            ...
            box-shadow: 0 40px 70px rgba(15, 5, 5, 0.4), 0 2px 0 rgba(255, 255, 255, 0.14) inset;
            text-align: center;
            overflow: hidden;
        }
        ...
        .om-heading {
            ...
            text-shadow: 0 -1px 0 rgba(255, 255, 255, 0.18), 0 1px 0 rgba(0, 0, 0, 0.35);
            opacity: 0;
