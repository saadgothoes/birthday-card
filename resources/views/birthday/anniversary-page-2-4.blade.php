...
<head>
    ...
    <title>Anniversary Card - Engraved Letter - Bright Red &amp; White</title>
    <style>
        ...
        * {
        ...
        .om-card {
            ...
            box-shadow: 0 40px 70px rgba(20, 5, 0, 0.4), 0 2px 0 rgba(255, 255, 255, 0.16) inset;
            text-align: center;
            overflow: hidden;
        }
        ...
        .om-monogram-mark {
            ...
            color: var(--ink);
            text-shadow: 0 -1px 0 rgba(255, 255, 255, 0.25), 0 1px 0 rgba(0, 0, 0, 0.35);
        }
