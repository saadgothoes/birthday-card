...
<head>
    ...
    <title>Anniversary Card - Page 3 - Red &amp; Gold</title>
    <style>
    * {
        margin: 0;
        padding: 0;
    ...
    :root {
        --wrap-bg: radial-gradient(circle at 30% 20%, #a35a56 0%, #7a3d3c 55%, #5c1420 100%);
        --tray-bg: linear-gradient(160deg, #b9827e 0%, #8f5350 100%);
        --tray-border: #5c1420;
        --box-bg: linear-gradient(135deg, #8b1e28 0%, #6e1420 55%, #4a0f18 100%);
        --lid-bg: linear-gradient(135deg, #9c2530 0%, #7a1824 55%, #551017 100%);
        --ribbon-v: linear-gradient(90deg, #6e4a1e 0%, #a3792f 25%, #f0d9a5 50%, #a3792f 75%, #6e4a1e 100%);
        --ribbon-h: linear-gradient(180deg, #6e4a1e 0%, #a3792f 25%, #f0d9a5 50%, #a3792f 75%, #6e4a1e 100%);
        --bow-loop: linear-gradient(135deg, #f0d9a5, #cf9f52 45%, #a3792f 80%, #6e4a1e 100%);
        --bow-tail: linear-gradient(180deg, #cf9f52, #7a5411);
        --bow-knot: radial-gradient(circle at 35% 30%, #f0d9a5, #cf9f52 60%, #7a5411 100%);
        --hint: rgba(240, 217, 165, 0.6);
        --ink: #f0d9a5;
        --accent: #a3792f;
        --accent-line: rgba(201, 167, 92, 0.55);
        --accent-wash: rgba(163, 121, 47, 0.18);
        --load-screen-bg: radial-gradient(circle at top, rgba(163, 121, 47, 0.28), transparent 40%), linear-gradient(160deg, rgba(46, 10, 16, 0.97), rgba(20, 6, 8, 0.96));
        --load-card-bg: linear-gradient(180deg, rgba(60, 20, 26, 0.96), rgba(30, 10, 14, 0.96));
        --load-card-ink: #f0d9a5;
        --load-card-border: rgba(201, 167, 92, 0.3);
        --load-glow: rgba(201, 167, 92, 0.2);
        --load-lid: linear-gradient(180deg, #f0d9a5, #cf9f52);
        --load-lid-border: #cf9f52;
        --load-box: linear-gradient(180deg, #8b1e28, #4a0f18);
        --load-ribbon: rgba(240, 217, 165, 0.9);
        --load-text: rgba(240, 217, 165, 0.82);
        --load-dot: #cf9f52;
        --confetti-1: #a3792f;
        --confetti-2: #f0d9a5;
        --confetti-3: #cf9f52;
...
<body>
    ...
    <div class="gift-container" style="position: relative;">
        <img src="/images/giftbox/anivar3.png" alt="Anniversary Gift" class="gift-image">
    ...
    function openGiftPage(pageNumber) {
        ...
        setTimeout(function() {
            ...
            // Gift-screen variant is fixed per file — this is variant 2.
            window.location.href = '/anniversary/page/3/2/gift/' + pageNumber + '/1';
        }, 900);
    }
