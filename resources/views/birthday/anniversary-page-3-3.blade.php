...
<head>
    ...
    <title>Anniversary Card - Page 3 - Ivory &amp; Peach-Gold</title>
    <style>
    * {
        margin: 0;
        padding: 0;
    ...
    :root {
        --wrap-bg: radial-gradient(circle at 30% 20%, #d8b98c 0%, #b08f62 55%, #9c7c52 100%);
        --tray-bg: linear-gradient(160deg, #f2ecdf 0%, #e0d6bd 100%);
        --tray-border: #9c7c52;
        --box-bg: linear-gradient(135deg, #faf5ea 0%, #efe3cd 55%, #e2d3b6 100%);
        --lid-bg: linear-gradient(135deg, #fdf9f0 0%, #f3e8d2 55%, #e7d9bd 100%);
        --ribbon-v: linear-gradient(90deg, #a5702f 0%, #e0a865 25%, #f7dcae 50%, #e0a865 75%, #a5702f 100%);
        --ribbon-h: linear-gradient(180deg, #a5702f 0%, #e0a865 25%, #f7dcae 50%, #e0a865 75%, #a5702f 100%);
        --bow-loop: linear-gradient(135deg, #f7dcae, #e0a865 45%, #c78a45 80%, #a5702f 100%);
        --bow-tail: linear-gradient(180deg, #e0a865, #a5702f);
        --bow-knot: radial-gradient(circle at 35% 30%, #f7dcae, #e0a865 60%, #a5702f 100%);
        --hint: rgba(74, 50, 32, 0.55);
        --ink: #4a3220;
        --accent: #c98a4a;
        --accent-line: rgba(201, 138, 74, 0.5);
        --accent-wash: rgba(201, 138, 74, 0.14);
        --load-screen-bg: radial-gradient(circle at top, rgba(201, 138, 74, 0.26), transparent 40%), linear-gradient(160deg, rgba(216, 185, 140, 0.97), rgba(156, 124, 82, 0.96));
        --load-card-bg: linear-gradient(180deg, rgba(242, 236, 223, 0.97), rgba(224, 214, 189, 0.97));
        --load-card-ink: #4a3220;
        --load-card-border: rgba(201, 138, 74, 0.32);
        --load-glow: rgba(201, 138, 74, 0.18);
        --load-lid: linear-gradient(180deg, #f7dcae, #e0a865);
        --load-lid-border: #e0a865;
        --load-box: linear-gradient(180deg, #faf5ea, #e2d3b6);
        --load-ribbon: rgba(165, 112, 47, 0.85);
        --load-text: rgba(74, 50, 32, 0.78);
        --load-dot: #c98a4a;
        --confetti-1: #c98a4a;
        --confetti-2: #f7dcae;
        --confetti-3: #e0a865;
...
<body>
    ...
    <div class="gift-container" style="position: relative;">
        <img src="/images/giftbox/anivar2.png" alt="Anniversary Gift" class="gift-image">
