...
<head>
    ...
    * {
    ...
    /* ================= MOBILE / TABLET (pure CSS blue-red gift boxes, below 1024px) ================= */
    ...
    .mobile-gifts-wrap {
        ...
        justify-content: center;
        padding: 24px;
        background: radial-gradient(circle at 30% 20%, #3a1010 0%, #1a0606 55%, #000 100%);
    }
    ...
    .mobile-gifts-card {
        ...
        aspect-ratio: 3 / 2;
        border-radius: 18px;
        background: linear-gradient(160deg, #6e1f1f 0%, #591616 100%);
    ...
    .mgb-box {
        ...
        background: linear-gradient(135deg, #6ea3f0 0%, #4177d6 55%, #2c56a8 100%);
        box-shadow:
    ...
    .mgb-lid {
        ...
        height: 20%;
        border-radius: 5px;
        background: linear-gradient(135deg, #79aef7 0%, #4a80da 55%, #2f5aac 100%);
    ...
    .mgb-lid::before {
        ...
        background: linear-gradient(90deg, #7a1414 0%, #f34747 22%, #ff8f8f 50%, #f34747 78%, #7a1414 100%);
    }

    /* horizontal red band across the box */
    .mgb-box::after {
        content: '';
        position: absolute;
        left: 0;
        ...
        top: 14%;
        height: 18%;
        background: linear-gradient(180deg, #7a1414 0%, #f34747 30%, #ff8f8f 50%, #f34747 70%, #7a1414 100%);
    }
    ...
    .mgb-bow-loop {
        ...
        width: 55%;
        height: 100%;
        background: linear-gradient(135deg, #ff8f8f, #f34747 45%, #c81f1f 80%, #7a1414 100%);
    ...
    .mgb-bow-tail {
        ...
        width: 16%;
        height: 42%;
        background: linear-gradient(180deg, #f34747, #a51e1e);
    }
    ...
    .mgb-bow-knot {
        ...
        height: 40%;
        border-radius: 40%;
        background: radial-gradient(circle at 35% 30%, #ff8f8f, #e23838 60%, #7a1414 100%);
    ...
    /* ================= LOADING SCREEN (shared, red-blue theme) ================= */
    ...
    .loading-screen {
        ...
        padding: 24px;
        background:
            radial-gradient(circle at top, rgba(243, 71, 71, 0.28), transparent 40%),
            linear-gradient(160deg, rgba(6, 10, 30, 0.98), rgba(30, 6, 10, 0.94));
        opacity: 0;
        visibility: hidden;
        pointer-events: none;
    ...
    .loading-card {
        ...
        text-align: center;
        color: #eaf1ff;
        background: linear-gradient(180deg, rgba(24, 18, 40, 0.96), rgba(30, 10, 16, 0.96));
        border: 1px solid rgba(243, 71, 71, 0.28);
    ...
    .loading-card::after {
        ...
        height: 120px;
        border-radius: 50%;
        background: radial-gradient(circle, rgba(110, 163, 240, 0.22), transparent 68%);
        pointer-events: none;
    }
    ...
    .loading-card::after {
        right: -35px;
        bottom: -50px;
        background: radial-gradient(circle, rgba(243, 71, 71, 0.22), transparent 68%);
    }
    ...
    .loading-gift-lid {
        ...
        height: 24px;
        border-radius: 14px;
        background: linear-gradient(180deg, #ff8f8f, #f34747);
    ...
    .loading-gift-box {
        ...
        height: 68px;
        border-radius: 18px;
        background: linear-gradient(180deg, #4177d6, #2c56a8);
...
<body>
    ...
    <div class="gift-container" style="position: relative;">
        ...
        <div class="gift-overlay">
            ...
            <!-- Gift 2 - Centre -->
            <div class="gift-area" id="gift2" style="top: 33%; left: 40%; width: 20%; height: 35%;"
                onclick="openGiftPage(2)">
            </div>

            <!-- Gift 3 - Right -->
            <div class="gift-area" id="gift3" style="top: 33%; right: 11%; width: 20%; height: 35%;"
                onclick="openGiftPage(3)">
            </div>
        </div>
    </div>

    <!-- ============ MOBILE / TABLET (below 1024px) - pure CSS blue-red gift boxes ============ -->
    ...
    function openGiftPage(pageNumber) {
        ...
        setTimeout(function() {
            window.location.href = '/boy/page/3/2/gift/' + pageNumber + '/1';
        }, 900);
    }
