...
<head>
    ...
    <title>Light — Warm Coffee — Happy Birthday Card</title>
    ...
    *::after {
    ...
    body {
        ...
        justify-content: center;
        background:
            url('data:image/svg+xml;base64,'),
            radial-gradient(ellipse at center, #3a2a1a 0%, #1a1008 100%);
    ...
    <div class="card-outer">
        <div class="card lt1">
            ...
            <div class="pol pol1">
                <div class="pol-inner">
                    <svg viewbox="0 0 118 118" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="90" cy="12" fill="#ffcc44" opacity="0.18" r="7"></circle>
            ...
            <div class="pol pol2">
                <div class="pol-inner">
                    <svg viewbox="0 0 124 124" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="25" cy="35" fill="#ffcc55" opacity="0.18" r="10"></circle>
                        <rect fill="#1a0d06" height="32" width="124" x="0" y="92"></rect>
                        <rect fill="#5a3820" height="5" rx="2" width="108" x="8" y="90"></rect>
                        ...
                        <ellipse cx="62" cy="58" fill="#2a1a0a" opacity="0.7" rx="7" ry="4"></ellipse>
                        <rect fill="#e8e4de" height="36" rx="7" width="32" x="46" y="59"></rect>
                        <ellipse cx="40" cy="80" fill="#c8a882" rx="6" ry="4"></ellipse>
                        <ellipse cx="84" cy="74" fill="#c8a882" rx="6" ry="4"></ellipse>
            ...
            <div class="pol pol3">
                <div class="pol-inner">
                    <svg viewbox="0 0 108 108" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ellipse cx="54" cy="55" fill="#f9a8b0" opacity="0.7" rx="4" ry="2"></ellipse>
                        <rect fill="#e0dcd6" height="36" rx="7" width="30" x="39" y="60"></rect>
                        <ellipse cx="41" cy="80" fill="#c8a882" rx="6" ry="4"></ellipse>
                        <ellipse cx="67" cy="76" fill="#c8a882" rx="6" ry="4"></ellipse>
            ...
            <svg class="kitty" viewbox="0 0 38 44" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="19" cy="28" fill="#fff" rx="15" ry="15" stroke="#eee" stroke-width="1"></ellipse>
                <polygon fill="#e22" points="11,11 18,15 11,19"></polygon>
                <polygon fill="#e22" points="27,11 20,15 27,19"></polygon>
                <ellipse cx="19" cy="14" fill="#e22" rx="4" ry="3"></ellipse>
                <circle cx="14" cy="26" fill="#222" r="2"></circle>
                <circle cx="24" cy="26" fill="#222" r="2"></circle>
                <ellipse cx="19" cy="31" fill="#f9a" rx="2" ry="1.5"></ellipse>
                <line stroke="#666" stroke-width="0.8" x1="4" x2="13" y1="27" y2="29"></line>
                <line stroke="#666" stroke-width="0.8" x1="4" x2="13" y1="31" y2="31"></line>
                <line stroke="#666" stroke-width="0.8" x1="25" x2="34" y1="29" y2="27"></line>
                <line stroke="#666" stroke-width="0.8" x1="25" x2="34" y1="31" y2="31"></line>
            </svg>
            <span class="sm-heart" style="bottom:8%;left:46%">♥</span>
            <span class="sm-heart" style="bottom:6%;left:52%">♥</span>
        </div>
    </div>
    <a class="next-btn" href="card2_light_dusty_rose.html">
        Next
