...
<head>
    ...
    <title>Midnight Boy · birthday card</title>
    ...
    * {
    ...
    body {
        ...
        background:
            url('data:image/svg+xml;base64,'),
            radial-gradient(ellipse at 30% 40%, #1e1a2a 0%, #0a080e 100%);
    ...
    .lip {
        ...
        color: #6b5a7a;
        opacity: 0.22;
        filter: drop-shadow(0 0 2px #3d2a4a);
    }

    /* --- hb sticker (midnight boy) --- */
    .hb-sticker {
        position: absolute;
        top: 2.5%;
        left: 50%;
    ...
    /* --- hello kitty → dark mascot (wolf / boy) --- */
    .kitty {
        position: absolute;
        bottom: 2%;
        left: 24%;
...
<body>
    <div class="card-outer">
        <div class="card">
            ...
            <!-- FAV -->
            <div class="fav">Favorite<br />Boy →</div>

            <!-- POLAROIDS (dark svg with muted tones) -->
            <div class="pol pol1">
                <div class="pol-inner">
                    @if(request('photo1'))
                    ...
                    <svg viewBox="0 0 118 118" xmlns="http://www.w3.org/2000/svg">
                        <rect fill="#14101e" height="118" width="118" />
                        <circle cx="25" cy="18" fill="#7a6a8a" opacity="0.2" r="10" />
                        <ellipse cx="38" cy="44" fill="#8a7a8a" rx="8" ry="9" />
                        <ellipse cx="38" cy="37" fill="#1a1220" rx="8" ry="6" />
                        <rect fill="#3a2a42" height="32" rx="4" width="18" x="29" y="53" />
                        <rect fill="#3a2a42" height="22" rx="3" width="7" x="25" y="55" />
                        <rect fill="#3a2a42" height="22" rx="3" width="7" x="41" y="55" />
                        <rect fill="#4a3a52" height="18" rx="3" width="7" x="31" y="85" />
                        <rect fill="#4a3a52" height="18" rx="3" width="7" x="39" y="85" />
                        <ellipse cx="80" cy="44" fill="#8a7a8a" rx="8" ry="9" />
                        <ellipse cx="80" cy="37" fill="#1a1220" rx="8" ry="6" />
                        <rect fill="#8a7a8a" height="32" rx="4" width="18" x="71" y="53" />
                        <rect fill="#8a7a8a" height="22" rx="3" width="7" x="67" y="55" />
                        <rect fill="#8a7a8a" height="22" rx="3" width="7" x="83" y="55" />
                        <rect fill="#4a3a52" height="18" rx="3" width="7" x="73" y="85" />
                        <rect fill="#4a3a52" height="18" rx="3" width="7" x="81" y="85" />
                        <ellipse cx="59" cy="66" fill="#8a7a8a" opacity="0.6" rx="5" ry="4" />
                    </svg>
                    @endif
                </div>
            </div>
            ...
            <div class="pol pol2">
                <div class="pol-inner">
                    ...
                    <svg viewBox="0 0 124 124" xmlns="http://www.w3.org/2000/svg">
                        <rect fill="#14101e" height="124" width="124" />
                        <circle cx="95" cy="25" fill="#7a6a8a" opacity="0.2" r="16" />
                        <rect fill="#0e0a14" height="32" width="124" x="0" y="92" />
                        <ellipse cx="62" cy="47" fill="#8a7a8a" rx="11" ry="12" />
                        <ellipse cx="62" cy="38" fill="#1a1220" rx="11" ry="7" />
                        <ellipse cx="52" cy="43" fill="#1a1220" rx="5" ry="8" />
                        <ellipse cx="72" cy="43" fill="#1a1220" rx="5" ry="8" />
                        <rect fill="#6a5a6a" height="36" rx="7" width="32" x="46" y="59" />
                        <ellipse cx="40" cy="80" fill="#8a7a8a" rx="6" ry="4" />
                        <rect fill="#3a2a42" height="18" rx="3" width="9" x="52" y="95" />
                        <rect fill="#3a2a42" height="18" rx="3" width="9" x="63" y="95" />
                    </svg>
                    @endif
                </div>
            </div>
            ...
            <div class="pol pol3">
                <div class="pol-inner">
                    ...
                    <svg viewBox="0 0 108 108" xmlns="http://www.w3.org/2000/svg">
                        <rect fill="#14101e" height="108" width="108" />
                        <circle cx="54" cy="20" fill="#7a6a8a" opacity="0.15" r="22" />
                        <ellipse cx="54" cy="46" fill="#8a7a8a" rx="13" ry="14" />
                        <ellipse cx="54" cy="36" fill="#1a1220" rx="13" ry="8" />
                        <ellipse cx="43" cy="40" fill="#1a1220" rx="5" ry="9" />
                        <ellipse cx="65" cy="40" fill="#1a1220" rx="5" ry="9" />
                        <circle cx="48" cy="47" fill="#3a2a42" r="2" />
                        <circle cx="60" cy="47" fill="#3a2a42" r="2" />
                        <rect fill="#6a5a6a" height="36" rx="7" width="30" x="39" y="60" />
                        <ellipse cx="41" cy="80" fill="#8a7a8a" rx="6" ry="4" />
                        <rect fill="#3a2a42" height="10" rx="3" width="8" x="42" y="96" />
                        <rect fill="#3a2a42" height="10" rx="3" width="8" x="58" y="96" />
                    </svg>
                    @endif
                </div>
            </div>
            ...
            <svg class="kitty" viewBox="0 0 38 44" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="19" cy="28" fill="#1c1428" rx="15" ry="15" stroke="#5a4a6a" stroke-width="1" />
                <polygon fill="#6a5a7a" points="11,11 18,15 11,19" />
                <polygon fill="#6a5a7a" points="27,11 20,15 27,19" />
                <ellipse cx="19" cy="14" fill="#6a5a7a" rx="4" ry="3" />
                <circle cx="14" cy="26" fill="#c8b8d8" r="2" />
                <circle cx="24" cy="26" fill="#c8b8d8" r="2" />
                <ellipse cx="19" cy="31" fill="#9a8aaa" rx="2" ry="1.5" />
                <line stroke="#5a4a6a" stroke-width="0.8" x1="4" x2="13" y1="27" y2="29" />
                <line stroke="#5a4a6a" stroke-width="0.8" x1="4" x2="13" y1="31" y2="31" />
                <line stroke="#5a4a6a" stroke-width="0.8" x1="25" x2="34" y1="29" y2="27" />
                <line stroke="#5a4a6a" stroke-width="0.8" x1="25" x2="34" y1="31" y2="31" />
            </svg>
    ...
    <a class="next-btn" href="card1_light_warm_coffee.html">
        Next
