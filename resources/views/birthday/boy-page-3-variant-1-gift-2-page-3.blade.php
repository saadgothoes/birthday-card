            ...
            <div class="card">
                <div class="grid">
                    ...
                    @php
                        ...
                        $markedDay = (int) request('cal_day', 21);
                    @endphp
                    <div class="tile cal">
                        <p class="cal-title">{{ request('cal_month', 'June 2022') }}</p>
                        <div class="cal-dow">
                ...
                <div class="note">
                    <p>{{ request('message', 'In a world full of color, I still pick you, every single time.') }}</p>
                    <span class="signed">{{ request('signed', '— forever, L') }}</span>
                </div>
