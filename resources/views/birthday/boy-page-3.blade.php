...
<body>
    ...
    <div class="gift-container" style="position: relative;">
        ...
        <div class="gift-overlay">
            ...
            <!-- Gift 2 - Centre -->
            <div class="gift-area" id="gift2" style="top: 30%; left: 40%; width: 22%; height: 38%;"
                onclick="openGiftPage(2)">
            </div>

            <!-- Gift 3 - Right -->
            <div class="gift-area" id="gift3" style="top: 30%; right: 10%; width: 22%; height: 38%;"
    ...
    function openGiftPage(pageNumber) {
        ...
        setTimeout(function() {
            window.location.href = '/boy/page/3/1/gift/' + pageNumber + '/1';
        }, 900);
    }
