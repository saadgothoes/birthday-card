...
<head>
   ...
   THEME: Boy — Midnight Gold (Dark Variant 3)
   ================================================== */
    :root {
        --bg: #0B0D12;
        /* Near-Black Navy */
        ...
        --text: #e8c468;
        --paper: #1B1F27;
        --paper-line: rgba(232, 196, 104, .18);
   ...
   ================================================== */
    ...
    .envelope-body {
        ...
        inset: 0;
        border-radius: 14px;
        background: linear-gradient(160deg, var(--paper) 0%, #11141a 100%);
    ...
    .envelope-seal {
        ...
        height: 58px;
        border-radius: 50%;
        background: radial-gradient(circle at 35% 30%, #D4AF37, #4A3910);
        display: flex;
        align-items: center;
        justify-content: center;
