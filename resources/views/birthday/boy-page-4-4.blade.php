...
<head>
   ...
   THEME: Boy — Slate Charcoal / Emerald Green (Variant 2)
   ================================================== */
    :root {
        --bg: #EEF2EF;
        /* Cool Sage Ivory */
        ...
        --text: #1c2521;
        --paper: #FBFDFC;
        --paper-line: rgba(28, 37, 33, .16);
        --shadow: 0 20px 45px rgba(28, 37, 33, 0.22);
        --shadow-soft: 0 10px 30px rgba(28, 37, 33, 0.14);
        --radius: 26px;
   ...
   ================================================== */
    ...
    .envelope-body {
        ...
        inset: 0;
        border-radius: 14px;
        background: linear-gradient(160deg, var(--paper) 0%, #dbe8e0 100%);
    ...
    .envelope-seal {
        ...
        height: 58px;
        border-radius: 50%;
        background: radial-gradient(circle at 35% 30%, #3E7A5C, #1C2521);
        display: flex;
        align-items: center;
        justify-content: center;
