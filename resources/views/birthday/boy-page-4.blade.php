...
<head>
   ...
   THEME: Boy — Cool Steel / Midnight Navy
   ================================================== */
    :root {
        --bg: #EEF3F8;
        /* Cool Ivory Blue */
        ...
        --text: #16233a;
        --paper: #FBFDFF;
        --paper-line: rgba(22, 35, 58, .16);
        --shadow: 0 20px 45px rgba(22, 35, 58, 0.22);
        --shadow-soft: 0 10px 30px rgba(22, 35, 58, 0.14);
        --radius: 26px;
   ...
   ================================================== */
    ...
    .envelope-body {
        ...
        inset: 0;
        border-radius: 14px;
        background: linear-gradient(160deg, var(--paper) 0%, #dbe7f2 100%);
    ...
    .envelope-seal {
        ...
        height: 58px;
        border-radius: 50%;
        background: radial-gradient(circle at 35% 30%, #3E6E96, #16233A);
        display: flex;
        align-items: center;
        justify-content: center;
