...
<head>
    ...
    <title>Birthday Card - Boy Theme</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="boy2-wrap">
        ...
        <div class="boy2-deco">
            ...
            <div style="position:absolute;top:0;left:0;right:0;bottom:0;background:radial-gradient(ellipse at 30% 50%, rgba(200,100,0,0.08) 0%, transparent 60%);pointer-events:none"></div>
            ...
            <div class="arch-frame">
                ...
                <div class="arch-photo">
                    <svg viewBox="0 0 190 256" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M68 148 Q95 125 122 148" stroke="#7a4520" stroke-width="1.5" fill="none" clip-path="url(#archclip)" />
                        ...
                        <ellipse cx="95" cy="50" rx="50" ry="20" fill="rgba(255,120,0,0.15)" clip-path="url(#archclip)" />
