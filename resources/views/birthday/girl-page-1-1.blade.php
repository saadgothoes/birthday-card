...
<body>
    <div class="girl2-wrap">
        ...
        <div class="girl2-deco">
            ...
            <div
                style="position:absolute;top:0;left:0;right:0;bottom:0;background:radial-gradient(ellipse at 30% 50%, rgba(255,105,180,0.08) 0%, transparent 60%);pointer-events:none">
            </div>
            ...
            <div class="arch-frame">
                ...
                <div class="arch-photo">
                    <svg viewBox="0 0 190 256" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M68 148 Q95 125 122 148" stroke="#ff69b4" stroke-width="1.5" fill="none"
                        ...
                        <ellipse cx="95" cy="50" rx="50" ry="20" fill="rgba(255,105,180,0.15)"
                            clip-path="url(#archclip)" />
        ...
        <div class="girl2-right">
            ...
            <div class="girl2-subtitle">— secret access —ssssss</div>
            ...
            <div class="girl2-numpad">
                <button class="girl2-btn">1aaaaaaaaaa</button>
