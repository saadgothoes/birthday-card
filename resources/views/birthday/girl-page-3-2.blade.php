...
<body>
    ...
    <div class="gift-container" style="position: relative;">
        ...
        <div class="gift-overlay">
            ...
            <!-- Gift 2 - Centre -->
            <div class="gift-area" id="gift2" style="top: 25%; left: 39%; width: 22%; height: 43%;"
                onclick="openGiftPage(2)">
            </div>

            <!-- Gift 3 - Right -->
            <div class="gift-area" id="gift3" style="top: 25%; right: 11%; width: 22%; height: 43%;"
    ...
    function openGiftPage(pageNumber) {
        ...
        setTimeout(function() {
            window.location.href = '/girl/page/3/2/gift/' + pageNumber + '/1';
        }, 900);
    }
