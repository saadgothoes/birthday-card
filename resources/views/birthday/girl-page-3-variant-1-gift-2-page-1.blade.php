...
===================================================================================== */
        :root {
            ...
            --bg-dark-rgb: 34, 26, 53;
            --bg-light-rgb: 61, 47, 89;
            --card-rgb: 86, 65, 116;
            --primary-rgb: 169, 124, 255;
            --secondary-rgb: 230, 216, 255;
            --accent-rgb: 201, 155, 255;
            --gold-rgb: 243, 216, 255;
            --text-light-rgb: 255, 252, 255;
            --shadow-rgb: 0, 0, 0;
...
<body>
    ...
    <div class="stage-outer">
        <div class="app-frame" id="appFrame">
            ...
            <button class="gift2-help-button" id="gift2HelpButton" type="button"
                aria-label="How to open this gift" aria-expanded="false">ⓘ</button>
            <div class="gift2-help-dialog" id="gift2HelpDialog" role="dialog" aria-label="How to open this gift">
                <strong>How to open this gift</strong>
            ...
            <div class="reveal-stage" id="revealStage">
                ...
                <div class="polaroid" id="photo0" style="--tilt:-7deg"
                    data-src="{{ request('photo1', 'https://picsum.photos/seed/giftphoto1/500/560') }}"
                    tabindex="0" role="button" aria-label="View memory one">
                    <img src="{{ request('photo1', 'https://picsum.photos/seed/giftphoto1/500/560') }}"
                        alt="A cherished memory">
                    <p class="polaroid-cap">{{ request('cap1', 'memory one') }}</p>
                </div>
                <div class="polaroid" id="photo1" style="--tilt:5deg"
                    data-src="{{ request('photo2', 'https://picsum.photos/seed/giftphoto2/500/560') }}"
                    tabindex="0" role="button" aria-label="View memory two">
                    <img src="{{ request('photo2', 'https://picsum.photos/seed/giftphoto2/500/560') }}"
                        alt="A cherished memory">
                    <p class="polaroid-cap">{{ request('cap2', 'memory two') }}</p>
                </div>
                <div class="polaroid" id="photo2" style="--tilt:-4deg"
                    data-src="{{ request('photo3', 'https://picsum.photos/seed/giftphoto3/500/560') }}"
                    tabindex="0" role="button" aria-label="View memory three">
                    <img src="{{ request('photo3', 'https://picsum.photos/seed/giftphoto3/500/560') }}"
                        alt="A cherished memory">
