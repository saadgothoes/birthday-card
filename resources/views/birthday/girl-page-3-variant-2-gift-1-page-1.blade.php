...
<head>
    ...
    :root {
        /* ---- base surface colors ---- */
        --bg-dark-1: #3B1626;
        /* sabse gehra background (page ka pichla hissa) */
        --bg-dark-2: #4E1E33;
        /* thoda halka background, gradient ke liye */
        --bg-dark-3: #200D18;
        /* sabse deep corner shade */

        --paper-light: #FFF3F7;
        /* card ka "paper" color (top)   */
        --paper-mid: #FBD9E6;
        /* card ka "paper" color (blush) */
        --paper-white: #FFFDFB;
        /* polaroid frame ka white       */

        /* ---- accent / brand colors ---- */
        --accent-1: #F472A0;
        /* main girly pink accent           */
        --accent-2: #D9558F;
        /* deeper pink, gradients ke liye    */
        --accent-3: #C99CE0;
        /* lavender accent (secondary pop)   */
        --accent-gold: #F6C6D9;
        /* halka shimmer / highlight color   */

        /* ---- text / ink colors ---- */
        --ink: #6E2A4C;
        /* handwriting / body ink color      */
        --ink-soft: #8C4468;
        /* thoda halka ink, subtitles k liye */
        --text-on-accent: #FFF6FA;
        /* accent backgrounds ke upar text   */

        /* ---- utility / rgb copies (for rgba() use) ---- */
        --bgdark1-rgb: 59, 22, 38;
        --bgdark2-rgb: 78, 30, 51;
        --paper-rgb: 255, 243, 247;
        --accent1-rgb: 244, 114, 160;
        --accent2-rgb: 217, 85, 143;
        --accent3-rgb: 201, 156, 224;
        --shadow-rgb: 0, 0, 0;

        /* ---- fonts (theme ka hissa nahi, par yahin rakha hai) ---- */
