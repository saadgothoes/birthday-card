...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,500;0,600;0,700;1,600&family=Inter:wght@400;500;600;700&family=Dancing+Script:wght@500;600;700&display=swap"
        rel="stylesheet">
    <style>
    /* ==================================================
   ...
   ================================================== */
    :root {
        ...
        --text-inverse: #fbeeea;
        --card: #fffaf6;
        --card-glass: rgba(255, 250, 246, 0.55);
        --shadow: 0 20px 45px rgba(40, 15, 15, 0.4);
        --shadow-soft: 0 10px 30px rgba(40, 15, 15, 0.18);
        --radius: 26px;
        --radius-sm: 14px;
    ...
    * {
    ...
    body {
        ...
        background: radial-gradient(120% 120% at 20% 0%, #3f2323 0%, var(--bg-dark) 55%, #170d0e 100%);
        overflow: hidden;
        position: relative;
   ...
   ================================================== */
    ...
    @media (min-width: 900px) {
        .phone {
            box-shadow: var(--shadow), inset 0 0 0 1px rgba(255, 255, 255, .25), 0 0 90px rgba(217, 162, 115, .15);
        }
    }
   ...
   ================================================== */
    .cover {
        ...
        padding: 28px;
        background:
            radial-gradient(120% 90% at 50% 0%, rgba(217, 162, 115, .25), transparent 60%),
            linear-gradient(165deg, #34201d 0%, #201213 100%);
    ...
    .cover-icon {
        ...
        box-shadow: 0 10px 24px rgba(217, 162, 115, .45);
    }
   ...
   ================================================== */
    ...
    @media (min-width: 1024px) {
        ...
        .phone {
            box-shadow: var(--shadow), inset 0 0 0 1px rgba(255, 255, 255, .25), 0 0 130px rgba(217, 162, 115, .18);
        }
    }
            ...
            <div class="status-bar">
                ...
                <span class="status-icons">
                    ...
                    <svg width="17" height="11" viewBox="0 0 17 11" fill="none">
                        <rect x="0" y="6" width="3" height="5" rx="0.7" fill="#fff" />
                        <rect x="4.5" y="4" width="3" height="7" rx="0.7" fill="#fff" />
                        <rect x="9" y="2" width="3" height="9" rx="0.7" fill="#fff" />
                        <rect x="13.5" y="0" width="3" height="11" rx="0.7" fill="#fff" />
                    </svg>
                    <!-- wifi -->
                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none">
                        <path d="M8 9.6a1.3 1.3 0 1 0 0 2.6 1.3 1.3 0 0 0 0-2.6Z" fill="#fff" />
                        <path d="M4.5 7.2a5 5 0 0 1 7 0" stroke="#fff" stroke-width="1.4" stroke-linecap="round" />
                        <path d="M1.8 4.5a9 9 0 0 1 12.4 0" stroke="#fff" stroke-width="1.4" stroke-linecap="round" />
                    </svg>
                    <!-- battery -->
                    <svg width="25" height="12" viewBox="0 0 25 12" fill="none">
                        <rect x="0.75" y="0.75" width="20.5" height="10.5" rx="2.5" stroke="#fff" stroke-opacity=".5"
                            stroke-width="1" />
                        <rect x="2.2" y="2.2" width="17.6" height="7.6" rx="1.4" fill="#fff" />
                        <path d="M23 4v4a1.7 1.7 0 0 0 1-1.5V5.5A1.7 1.7 0 0 0 23 4Z" fill="#fff" fill-opacity=".5" />
                    </svg>
                </span>
            </div>
