...
<head>
   ...
   ================================================== */
    :root {
        ...
        --text-inverse: #f3eefc;
        --card: #fbf9ff;
        --card-glass: rgba(251, 249, 255, 0.55);
        --shadow: 0 20px 45px rgba(15, 10, 40, 0.4);
        --shadow-soft: 0 10px 30px rgba(15, 10, 40, 0.18);
        --radius: 26px;
        --radius-sm: 14px;
    ...
    * {
    ...
    body {
        ...
        background: radial-gradient(120% 120% at 20% 0%, #302a40 0%, var(--bg-dark) 55%, #120e1a 100%);
        overflow: hidden;
        position: relative;
   ...
   ================================================== */
    ...
    @media (min-width: 900px) {
        .phone {
            box-shadow: var(--shadow), inset 0 0 0 1px rgba(255, 255, 255, .25), 0 0 90px rgba(169, 146, 217, .15);
        }
    }
   ...
   ================================================== */
    .cover {
        ...
        padding: 28px;
        background:
            radial-gradient(120% 90% at 50% 0%, rgba(169, 146, 217, .25), transparent 60%),
            linear-gradient(165deg, #291f38 0%, #180f22 100%);
    ...
    .cover-icon {
        ...
        box-shadow: 0 10px 24px rgba(169, 146, 217, .45);
    }
   ...
   ================================================== */
    ...
    @media (min-width: 1024px) {
        ...
        .phone {
            box-shadow: var(--shadow), inset 0 0 0 1px rgba(255, 255, 255, .25), 0 0 130px rgba(169, 146, 217, .18);
        }
    }
