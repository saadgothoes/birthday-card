...
<head>
   ...
   ================================================== */
    :root {
        ...
        --text-inverse: #fff1e6;
        --card: #fffaf4;
        --card-glass: rgba(255, 250, 244, 0.55);
        --shadow: 0 20px 45px rgba(45, 18, 8, 0.4);
        --shadow-soft: 0 10px 30px rgba(45, 18, 8, 0.18);
        --radius: 26px;
        --radius-sm: 14px;
    ...
    * {
    ...
    body {
        ...
        background: radial-gradient(120% 120% at 20% 0%, #402a1b 0%, var(--bg-dark) 55%, #170e08 100%);
        overflow: hidden;
        position: relative;
   ...
   ================================================== */
    ...
    @media (min-width: 900px) {
        .phone {
            box-shadow: var(--shadow), inset 0 0 0 1px rgba(255, 255, 255, .25), 0 0 90px rgba(240, 168, 120, .15);
        }
    }
   ...
   ================================================== */
    .cover {
        ...
        padding: 28px;
        background:
            radial-gradient(120% 90% at 50% 0%, rgba(240, 168, 120, .25), transparent 60%),
            linear-gradient(165deg, #33231a 0%, #1e130d 100%);
    ...
    .cover-icon {
        ...
        box-shadow: 0 10px 24px rgba(240, 168, 120, .45);
    }
   ...
   ================================================== */
    ...
    @media (min-width: 1024px) {
        ...
        .phone {
            box-shadow: var(--shadow), inset 0 0 0 1px rgba(255, 255, 255, .25), 0 0 130px rgba(240, 168, 120, .18);
        }
    }
