...
<head>
    ...
    :root {
        ...
        --ink: #3A2758;
        --card: #FDFBFF;
        --card-line: rgba(63, 42, 99, .16);
        --petal-a: #D9C6F2;
        --petal-b: #BFA3E6;
        --petal-c: #A98BD8;
        --leaf: #A6C0A8;
        --stem: #86A88C;
        --glow: rgba(169, 139, 216, .45);
        --shadow: 0 22px 50px rgba(63, 42, 99, .18);
        --shadow-soft: 0 10px 28px rgba(63, 42, 99, .12);
    ...
    * {
    ...
    .bud-core {
        ...
        margin: -12% 0 0 -12%;
        border-radius: 50%;
        background: radial-gradient(circle at 34% 30%, #FFF1D8, #E8C36B 70%, #C9A248);
    ...
    .keepsake {
        ...
        border-radius: 50%;
        background:
            radial-gradient(circle at 50% 12%, #fff 0%, var(--card) 58%, #F3ECFD 100%);
