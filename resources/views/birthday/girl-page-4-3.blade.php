...
:root {
    ...
    /* soft rose */
    --accent: #f0d0c0;
    /* warm cream highlight (readable on dark) */
    --ink: #9c5b45;
    /* warm terracotta, for letter ink */
    --text: #fbeeea;
    --paper: #fdf8ee;
    --paper-line: rgba(156, 91, 69, .18);
    --shadow: 0 20px 45px rgba(15, 5, 5, 0.5);
    --shadow-soft: 0 10px 30px rgba(15, 5, 5, 0.3);
    --radius: 26px;
