...
<head>
    ...
    :root {
        ...
        --ink: #EADFFB;
        --card: #221836;
        --card-line: rgba(234, 223, 251, .18);
        --petal-a: #9E7BD0;
        --petal-b: #7C5AAE;
        --petal-c: #5D4189;
        --leaf: #677C6E;
        --stem: #4E6155;
        --glow: rgba(199, 166, 240, .4);
        --shadow: 0 22px 50px rgba(0, 0, 0, .58);
    ...
    * {
    ...
    .bud-core {
        ...
        margin: -12% 0 0 -12%;
        border-radius: 50%;
        background: radial-gradient(circle at 34% 30%, #EFE0FF, #B48ADE 70%, #8E64C0);
    ...
    .keepsake {
        ...
        border-radius: 50%;
        background:
            radial-gradient(circle at 50% 12%, #2B2044 0%, var(--card) 58%, #1D1430 100%);
