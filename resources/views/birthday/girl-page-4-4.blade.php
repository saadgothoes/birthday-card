...
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,500;0,600;0,700;1,600&family=Inter:wght@400;500;600&family=Dancing+Script:wght@500;600;700&display=swap" rel="stylesheet">
<style>
/* ==================================================
   THEME VARIABLES — change these to re-skin everything
   THEME: Girl — Lavender Midnight (Dark)
   ================================================== */
:root {
    --bg: #201a2a;
    --bg-glow: #302a40;
    ...
    /* soft lilac */
    --accent: #ede6fb;
    /* pale lilac highlight (readable on dark) */
    --ink: #6a4f9c;
    /* deep violet, for letter ink */
    --text: #f3eefc;
    --paper: #fdf8ee;
    --paper-line: rgba(106, 79, 156, .18);
    --shadow: 0 20px 45px rgba(6, 4, 12, 0.5);
    --shadow-soft: 0 10px 30px rgba(6, 4, 12, 0.3);
    --radius: 26px;
...
body {
    ...
    background: radial-gradient(120% 120% at 20% 0%, var(--bg-glow) 0%, var(--bg) 55%, var(--bg-deep) 100%);
    overflow: hidden;
    position: relative;
...
.envelope-body {
    ...
    inset: 0;
    border-radius: 14px;
    background: linear-gradient(160deg, var(--paper) 0%, #f0e4cf 100%);
    ...
    <div class="letter-wrap" id="letterWrap">
        <div class="letter-paper">
            <div class="letter-stamp" id="letterStamp">
                <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M20.8 4.6c1.6 1.6 1.6 4.2 0 5.8L12 19.2l-8.8-8.8c-1.6-1.6-1.6-4.2 0-5.8 1.6-1.6 4.2-1.6 5.8 0L12 7.2l3-2.6c1.6-1.6 4.2-1.6 5.8 0Z"></path>
                </svg>
            </div>
...
envelope.addEventListener('keyup', e => { if (e.key === 'Enter' || e.key === ' ') openLetter(); });
