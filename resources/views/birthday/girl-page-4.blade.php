...
<head>
    ...
    :root {
        ...
        --ink: #5A2637;
        --card: #FFFAFB;
        --card-line: rgba(122, 50, 71, .16);
        --petal-a: #F6B9C8;
        --petal-b: #EE9DB2;
        --petal-c: #E8899F;
        --leaf: #A8BE96;
        --stem: #8FA87C;
        --glow: rgba(232, 137, 159, .45);
        --shadow: 0 22px 50px rgba(122, 50, 71, .18);
        --shadow-soft: 0 10px 28px rgba(122, 50, 71, .12);
    ...
    * {
    ...
    .bud-core {
        ...
        margin: -12% 0 0 -12%;
        border-radius: 50%;
        background: radial-gradient(circle at 34% 30%, #FFE9C9, #F0B472 70%, #D89A57);
    ...
    .keepsake {
        ...
        border-radius: 50%;
        background:
            radial-gradient(circle at 50% 12%, #fff 0%, var(--card) 58%, #FDEDF1 100%);
