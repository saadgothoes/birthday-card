{{--
    Proposal · Design 3 ("Written in the Stars") — theme 4, "Obsidian".
    ...
    /proposal/design/3/4 and rendered at /c/{slug} for a published card.
--}}
@include('birthday.partials.proposal-design-3', ['proposalTheme' => 4])
